            ...
            <div data-aos-anchor-placement="top-bottom" className=" mx-auto">
                <footer className="p-4 sm:p-6 dark:bg-gray-800">
                    <div className="md:flex md:justify-between">
                        <div data-aos="fade-up" className="mb-6 md:mb-0">
                            <a className="flex items-center">
                                <span className="self-center text-2xl md:text-3xl font-semibold whitespace-nowrap  text-blue-600">CollegeGuru</span>
                            </a>
                        </div>
                                ...
                                <ul>
                                    <li className="mb-4">
                                        <a href="#" target="_blank"
                                            className="text-gray-600 hover:underline dark:text-gray-400">CollegeGuru</a>
                                    </li>
                                    <li>
                    ...
                    <div  className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-lg text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a className="hover:underline">CollegeGuru™</a>. All Rights Reserved.
                        </span>
