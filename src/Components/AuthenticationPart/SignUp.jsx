        ...
        <div className="flex items-center justify-center md:min-h-screen bg-[#fcfcfc]">
            <div className="container mb-10 mt-10 my-auto max-w-md border-2 border-gray-200 p-3 bg-white">
                ...
                <div className="m-6">
                    <form onSubmit={handleSubmit(onSubmit)} className="mb-4">
                        ...
                        <div data-aos="fade-right" className="mb-6">
                            ...
                            <div className="relative">
                                ...
                                })} name="confirmPass" placeholder="Confirm Password" className="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-100 focus:border-blue-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" />
                    ...
                    <div data-aos="fade-left" className="flex justify-center mt-5">
                        <button onClick={GithubHandler} className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                            <div className="relative flex items-center space-x-10 justify-center">
                                <img src={`${github}`} className="absolute left-0 w-5" alt="google logo" />
